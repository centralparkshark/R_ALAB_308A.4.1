...
const API_KEY = "live_PYHiPvKKEgVNlXbAVlT6R25MrTbGVW0W3AHyUmEJ6T9IceP4hNpy0icagOSMW1hh";
...
export async function getFavourites() {
    ...
    try {
        ...
        let favouriteImgs = []
        try {
            for (const img of favourites) {
              const response = await axios.get(`https://api.thecatapi.com/v1/images/${img.image_id}`, {
                headers: {
                  'x-api-key': API_KEY,
                },
              });
        
              favouriteImgs.push(response.data);
            }
          } catch (error) {
